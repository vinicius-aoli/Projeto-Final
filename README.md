...
Alunos Integrantes: Rafael Antero Figueiroa (núm. usp: 16990694) e Vinícius Alves de Oliveira (núm. usp: 15498077)
Nome do projeto: GymStat.
...
'numpy' para manipulação de dados numéricos e 'matplotlib' para geração (plotagem) de gráficos estatístico.
...
*.csv: Bancos de dados do trabalho que utilizam o id do aluno:
...
No Linux e MacOS: python3 main.py
...
Nota: O sistema faz uma verificação de qual foi o último evento registrado (check-in ou check-out) para evitrar duplicidade de registro.
